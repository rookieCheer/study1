...
function sub(){
	//alert("0000");
	 var url = "${pageContext.request.contextPath}/Product/Admin/notice!editNotice.action";
	 $('#frm').attr("action", url).submit();
}
</script>
</head>
...
<div class="center">			
	...
	<div class="main" align="center" >
		...
		<form id="frm" action="${pageContext.request.contextPath}/Product/Admin/notice!editNotice.action" method="post" enctype="multipart/form-data" onsubmit="return isSubmit()">
				<table border="1" style="width: 977px;">
					...
					<c:if test="${notice.titleUrl == '' || notice.titleUrl eq null}">
						<tr>
							<td class="rightText" style="text-align: right;vertical-align: top;width:102px;">标题缩略图：</td>
					...
					<tr>
						...
						<td class="leftText" style="width:auto">
							<input  id="title" name="notice.title" style="width: 100%;" value="${notice.title}"><br>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>公告ID</td>
						<td><input type="text" name="notice.noticeId" value="${notice.noticeId}"></td>
					</tr>
					<tr>
						<td>活动链接</td>
						<td><input type="text" name="notice.hdUrl" value="${notice.hdUrl}"></td>
					</tr>
					<tr>
						<td class="rightText" style="width:100px;"><span style="color: red;">*</span>公告描述：</td>
						<td class="leftText" style="width:auto">
							<textarea name="notice.description" id="description" maxlength="100" id="" style="width:88%">${notice.description}</textarea>(100字以内) <br>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<input type="hidden" id="hidDescr" name="notice.content">
							...
							<%-- <textarea id="editor_id" style="width:880px;height:300px;" name="content">${notice.content}</textarea> --%>
...
<%-- 	<form action="${pageContext.request.contextPath}/Product/Admin/releaseProduct!test.action" style="display:none;">
	...
	<input type="submit" style="text-align: center;width:200px; height: 50px; font-size: 24px" value="修改" onClick="javascript:Submit();">
	</form> --%>
</body>
<script type="text/javascript">
...
<script type="text/javascript">
var type='${notice.isTop}';
$("input[name='notice.isTop'][value='"+type+"'").attr("checked",true);
</script>
</html>