			...
			<c:forEach items="${list}"  var="item" varStatus="i">
				<tr>
					...
					<td style="text-align: center;">
						<a class="a" href="${pageContext.request.contextPath}/Product/Admin/userStat!loadUsersStat.action?insertTime=<fmt:formatDate value="${myel:formatDate(item.date)}" pattern="MM/dd/yyyy"/>">${item.date}</a>
					</td>
					<td style="text-align: center;">
						${item.userscount}
					</td>
