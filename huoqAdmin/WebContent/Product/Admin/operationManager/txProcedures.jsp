...
<div class="center">			
	...
	<div class="main" align="center">
			<h3 style="text-align: center;">提现手续费</h3><br>
		...
		<fmt:formatNumber value="${txTotalAmount}" pattern="#,##0.##"/>(元)</td>
...
$("body").keydown(function(e){
	...
	function Byname(){
		...
		var url="${pageContext.request.contextPath}/Product/Admin/tXProcedures!showTXProcedures.action?insertTime="+$('#insertTime').val();
