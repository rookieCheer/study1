...
<head>
    ...
    <script type="text/javascript">
        function ireportDo(){
            ...
            var url='${pageContext.request.contextPath}/Product/Admin/userStat!iportIndexUserInfo.action?currentPage=${currentPage}&name='+name+'&insertTime='+insertTime+'&channel='+channel+'&isbindbank='+isbindbank+'&level='+level+'&inMoney1='+inMoney1+'&inMoney2='+inMoney2;
            var list="${list}";
            if(list!=null&&list!="[]"){
                var my= art.dialog({
                    title: '提示',
    ...
    <script type="text/javascript">
        ...
        function queryProduct(){
            ...
            var url = "${pageContext.request.contextPath}/Product/Admin/userStat!indexUserInfo.action?insertTime="+insertTime+"&username="+username+"&isbindbank="+isbindbank+"&channel="+channel+"&level="+level+"&inMoney1="+inMoney1+"&inMoney2="+inMoney2+
                "&acinsertTime="+acinsertTime;
        ...
        function goqueryProduct(){
            ...
            var url = "${pageContext.request.contextPath}/Product/Admin/userStat!indexUserInfo.action?insertTime="+insertTime+"&username="+username+"&isbindbank="+isbindbank+"&channel="+channel+"&level="+level+"&inMoney1="+inMoney1+"&inMoney2="+inMoney2+"&goPage="+goPage;
            window.location.href=url;
        }
...
<div class="center">
    ...
    <div class="main" align="center">
        ...
        <table border="0.5" cellspacing="0" cellpadding="0" align="center" style="margin-top:10px;width:90%;text-align: center;">
            <tr align="center">
                <td width="50px;">编号</td>
            ...
            <c:forEach items="${pageUtil.list}" var="item" varStatus="i">
                <tr >
                    ...
                    <td align="center"><a class="a"  href="${pageContext.request.contextPath}/Product/Admin/userStat!indexUserInfo.action?username=${myel:jieMiUsername(item.username)}">${myel:jieMiUsername(item.username)}</a></td>
                    ...
                    <td align="center" style="margin: 10px; padding:0 10px;">
                        <a class="a" href="javascript:queryIns('${myel:jieMiUsername(item.username)}','${item.isBindBank}')">投资记录</a>
                        ...
                        <a class="a" target="_blank" href="${pageContext.request.contextPath}/Product/Admin/account!showMyPurse.action?username=${myel:jieMiUsername(item.username)}">账户详情</a>
                        <c:if test="${item.isBindBank == '1'}">
                            <a class="a" target="_blank" href="${pageContext.request.contextPath}/Product/Admin/bindCardRecord!findAccount.action?name=${myel:jieMiUsername(item.username)}&isBindBank=${item.isBindBank}">绑卡人信息</a>
        ...
        <c:choose>
            <c:when test="${pageUtil.list ne '[]' &&  pageUtil.list ne '' && pageUtil.list ne null}"><jsp:include page="/Product/page.jsp" />
