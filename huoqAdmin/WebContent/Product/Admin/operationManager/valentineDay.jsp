...
function Byname(){
	...
	var url="${pageContext.request.contextPath}/Product/Admin/bannerActivity!loadValentineDay.action?username="+username+"&sumMoney="+sumMoney;
...
<div class="center">			
	...
	<div class="main" align="center">
		<h3 style="text-align: center;">情人节投资总额</h3><br/>
		...
		<select id="sumMoney" name="sumMoney">
				...
				<option value = "0">5-10万</option>
				<option value = "1">10-30万</option>
		...
		<td>${item[1] }</td>
		<td><a class="a"  href="${pageContext.request.contextPath}/Product/Admin/userStat!loadUserInfo.action?username=${myel:jieMiUsername(item[2])}">${myel:jieMiUsername(item[2])}</a></td>
		<td>
		<fmt:formatNumber value="${item[0]*0.01 }" pattern="0.00"/>
		</td>
		<td>${item[3] }</td>
		</tr>
		</c:forEach>
