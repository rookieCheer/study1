...
<title>未投资新手产品的用户信息</title>
	...
	<script type="text/javascript">
        function ireportDo() {
            ...
            var url = '${pageContext.request.contextPath}/Product/Admin/usersInvInfo!iportRichData.action?';
            var list = "${list}";
            var my = art.dialog({
                title: '提示',
...
function Byname(){
	...
	var url="${pageContext.request.contextPath}/Product/Admin/usersInvInfo!loadNotBuyFreshPro.action?insertTime="+insertTime+"&username="+username;
...
<div class="center">			
	...
	<div class="main" align="center">
		<h3 style="text-align: center;">未投资新手产品的用户信息</h3><br/>
		...
		<td width="200px" style="text-align: center;">
			...
			<c:if test="${item[6] ne null}">
				<fmt:formatNumber value="${item[6]}" pattern="#,##0"/>
			</c:if>
		</td>
		<td width="200px" style="text-align: center;">
