...
function queryProduct(){
	...
	var url = "${pageContext.request.contextPath}/Product/Admin/investors!platResUserInverstors.action?insertTime="+insertTime;
	...
	<table border="0.5" cellspacing="0" cellpadding="0">
		<tbody>
				<tr>
					...
					<td width="100px" style="text-align: center;">注册且投资人数</td>
			...
			<c:forEach items="${list}"  var="item" varStatus="i">
				<tr>
					...
					<td style="text-align: center;">
						<a class="a" href="${pageContext.request.contextPath}/Product/Admin/investors!findInvertors.action?type=1&insertTime=<fmt:formatDate value="${myel:formatDate(item.date)}" pattern="MM/dd/yyyy"/>">${item.date}</a>
					</td>
					<td style="text-align: center;">
						${item.userscount}
					</td>
