...
<!-- 引入时间组件 -->
<script
	src="${pageContext.request.contextPath}/Product/Admin/js/jQuery-calendar/js/laydate.js"></script>
...
<body>
		...
		<div class="main" align="center">
			...
			<div id="div_condition" style="text-align: center;">
				...
				<c:if test="${usersAdmin.id!=11020}">
					<label><input type="button" value="启动【提现查询接口】线程"
						onclick="txThread()" id="startTxQueryThread"> </label>
				</c:if>
			...
			<c:choose>
				<c:when
					test="${txRecordList ne '[]' &&  txRecordList ne '' && txRecordList ne null}"><jsp:include
	...
	<script type="text/javascript">
		...
		function exportExcel() {
			...
			form.attr('action', 'recharge!exportExcelRecordList.action');
			var input1 = $('<input>');
			...
			input2.attr('name', 'insertTime');
			input2.attr('value', insertTime);
