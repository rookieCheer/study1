...
<div class="center">		
	...
	<table border="0.5" cellspacing="0" cellpadding="0">
		<tbody>
				<tr>
					<td width="200px" style="text-align: center;">到期日期</td>
					<td width="200px" style="text-align: center;">零钱罐余额</td>
					<td width="200px" style="text-align: center;">账户余额</td>
					<td width="200px" style="text-align: center;">到期本金</td>
					<td width="100px" style="text-align: center;">到期利息</td>
					<td width="100px" style="text-align: center;">预留金额</td>
				</tr>
			<c:forEach items="${list}"  var="item" >
				<tr>
					<td style="text-align: center;">${item.date}</td>
					<td style="text-align: center;">
						<fmt:formatNumber value="${item.lqgMoney}" pattern="#,##0.##" /> 
					</td>
					<td style="text-align: center;">
					...
					<td style="text-align: center;">
						<fmt:formatNumber value="${item.dqfxje}" pattern="#,##0.##" /> 
					</td>
					<td style="text-align: center;">
