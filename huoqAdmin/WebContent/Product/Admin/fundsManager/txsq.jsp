...
function ireportDo(){
    ...
    var status =  $('input[name=status]:checked').val();
	    var url='${pageContext.request.contextPath}/Product/Admin/checkTxsq!iportTXTable.action?currentPage=${currentPage}&name='+name+'&insertTime='+insertTime+'&status='+status;
...
<div class="center">			
	...
	<div class="main" align="center">
		...
		<td width="7%">流水号</td>
		<td width="8%">用户名</td>
		<td width="5%">提现金额(元)</td>
		<td width="5%">姓名</td>
		<td width="10%">申请提现时间</td>
		<td width="10%">审核提现时间</td>
