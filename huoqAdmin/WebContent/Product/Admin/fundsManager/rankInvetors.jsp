...
<head>
    ...
    <script type="text/javascript">
        function ireportDo() {
            ...
            var url = "${pageContext.request.contextPath}/Product/Admin/ranking!exportInvestorsRank.action?insertTime=" + insertTime;
            var list = "${list}";
            if (list != null && list != "[]") {
                var my = art.dialog({
                    title: '提示',
        ...
        <table border="0.5" cellspacing="0" cellpadding="0">
            ...
            <c:forEach items="${list}" var="item" varStatus="i">
                <tr>
                    ...
                    <td style="text-align: center;"><fmt:formatNumber value="${item.inmoney * 0.01}"
                                                                      pattern="#,##0.##"/></td>
                </tr>
            </c:forEach>
