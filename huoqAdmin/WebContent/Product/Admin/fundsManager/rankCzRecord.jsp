...
<head>
    ...
    <script type="text/javascript">
        function queryProduct() {
            ...
            var url = "${pageContext.request.contextPath}/Product/Admin/ranking!showCZRecordRank.action?insertTime=" + insertTime;
    ...
    <script type="text/javascript">
        function ireportDo() {
            var insertTime = $("#insertTime").val();
            var url = "${pageContext.request.contextPath}/Product/Admin/ranking!exportCZRecordRank.action?insertTime=" + insertTime;
            var list = "${list}";
            if (list != null && list != "[]") {
                var my = art.dialog({
                    title: '提示',
...
<div class="center">
    ...
    <div class="main" align="center">
        ...
        <!--<a class="sereach" href="javascript:queryProduct();">查询</a>  -->
        <table border="0.5" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td width="100px" style="text-align: center;">充值总金额（元）</td>
            </tr>
            <c:forEach items="${list}" var="item" varStatus="i">
                <tr>
                    ...
                    <td style="text-align: center;">
                        <a class="a"
                           href="${pageContext.request.contextPath}/Product/Admin/userStat!loadUserInfo.action?username=${myel:jieMiUsername(item.usersname)}">${myel:jieMiUsername(item.usersname)}</a>
                    </td>
                    <td style="text-align: center;">${item.realname}</td>
                    <td style="text-align: center;"><fmt:formatNumber value="${item.money * 0.01}"
                                                                      pattern="#,##0.##"/></td>
                </tr>
            </c:forEach>
