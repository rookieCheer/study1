...
<title>金秋投资达人排行榜</title>
</head>
<body>
<div class="center">			
	<jsp:include page="/Product/Admin/common/head.jsp"/>
	<div class="main" align="center">
		<h3 style="text-align: center;">金秋投资达人排行榜</h3><br/>
		...
		<td><a class="a"  href="${pageContext.request.contextPath}/Product/Admin/userStat!loadUserInfo.action?username=${item[1]}">${item[1]}</a></td>
		<td>${item[0] }</td>
...
<script type="text/javascript">
	...
	//var  realnames = encodeURI(encodeURI(realname,"utf-8"),"utf-8");
		var url="${pageContext.request.contextPath}/Product/Admin/bannerActivity!autumnActivity.action";
