...
<html>
	...
	<head><link rel="shortcut icon" href="${pageContext.request.contextPath}/Product/images/favicon.ico" type="image/x-icon">
		<meta charset="utf-8"/>
		<title>404</title>
		<link href="../Product/css/page_404.css" rel="stylesheet" type="text/css"/>
		<link href="../Product/css/common.css" rel="stylesheet" type="text/css">
	</head>
	
	<body>
		<jsp:include page="../Product/header.jsp" />
		<div class="main">
			<div class="tis">
				<div class="Reason">
					<p>你要查看的网页找不到！</p>
