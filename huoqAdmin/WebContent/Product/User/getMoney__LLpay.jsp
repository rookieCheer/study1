...
<div class="main">
	...
	<div class="fr my_info">
		...
		<div class="line1"></div>
		<form id="getMoney_form" autocomplete="off" class="box-chan">
			
			<div class="recharge_money mt40">
				<ul>
					<li>
					...
					<li>
						<span class="recharge_inp">
							<label>交易密码：<a class="red">*</a></label>
			...
			<a id="goToWithdraw" class="to_cz pay-tx">确认提现</a>
		</div>
