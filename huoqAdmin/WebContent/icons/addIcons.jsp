...
<div align="center">
    ...
    <div class="main">
        <h1 style="text-align: center;">添加图标</h1>
        <form action="${pageContext.request.contextPath}/Icons/icons!saveIcons.action"
        ...
        <table border="1" style="width: 850px;">
            ...
            <tr>
                ...
                <td class="leftText" style="width:80%">
                    <input id="name" name="icons.name" style="width: 300px">
                </td>
            </tr>
            <tr>
                <td>图标模块：</td>
            ...
            <tr>
                ...
                <td class="leftText">
                    <label><input type="radio" name="icons.isClick" value='0'>不可以</label>
                    <label><input type="radio" name="icons.isClick" checked="checked" value='1'>可以</label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="leftText">
                    <label><input type="radio" name="icons.status" value='0'>停用</label>
                    <label><input type="radio" name="icons.status" checked="checked" value='1'>启用</label>
                </td>
            </tr>
            <tr>
                <td class="rightText" style="width:20%"><span style="color: red;">*</span>是否是H5：</td>
                <td class="leftText">
                    <label><input type="radio" name="icons.type" value='0'>H5</label>
                    <label><input type="radio" name="icons.type" checked="checked" value='1'>原生</label>
                </td>
            </tr>
            <tr>
                <td class="rightText" style="width:20%"><span style="color: red;">*</span>H5地址：</td>
                <td class="leftText" style="width:80%">
                    <input id="h5URL" name="icons.H5URL" style="width: 300px">
                </td>
            </tr>
            <tr>
                <td class="rightText" style="width:20%"><span style="color: red;">*</span>是否需要登录：</td>
                <td class="leftText">
                    <label><input type="radio" name="icons.isLogin" value='0' checked="checked">不需要</label>
                    <label><input type="radio" name="icons.isLogin" value='1'>需要</label>
                </td>
            </tr>
            <tr>
                <td class="rightText" style="width:20%"><span style="color: red;">*</span>创建人：</td>
                <td class="leftText" style="width:80%">
                    <input id="creator" name="icons.creator" style="width: 300px">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <input type="submit" id="btn" style="text-align: center;width:200px; height: 50px; font-size: 24px" value="添加">
                </td>
            </tr>
        </table>
        </form>
