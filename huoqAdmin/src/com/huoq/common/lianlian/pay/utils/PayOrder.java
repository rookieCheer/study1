...
public class PayOrder implements Serializable {
    ...
    private String charset_name;//参数编码
    ...
    private String auth_pay_url;//请求地址
	...
	public String getAuth_pay_url() {
		return auth_pay_url;
	}

	public void setAuth_pay_url(String auth_pay_url) {
		this.auth_pay_url = auth_pay_url;
	}
