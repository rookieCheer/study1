...
public class InvestorsBean {
    ...
    public PageUtil<Investors> findInvertorses(PageUtil pageUtil, String productTitle, String status, String name, String insertTime) throws Exception {
        ...
        buffer.append(" ORDER BY i.pay_time DESC  ");
        ...
        if (!QwyUtil.isNullAndEmpty(list)) {
            for (Object[] object : list) {
                ...
                if (!QwyUtil.isNullAndEmpty(object)) {
                    ...
                    if (!QwyUtil.isNullAndEmpty(object[6])) {
                    ...
                    investors.setStartTime(!QwyUtil.isNullAndEmpty(object[17]) ? QwyUtil.fmyyyyMMddHHmmss.parse(object[17].toString()) : null);
                    investors.setClearTime(!QwyUtil.isNullAndEmpty(object[18]) ? QwyUtil.fmyyyyMMddHHmmss.parse(object[18].toString()) : null);
                    investors.setFinishTime(!QwyUtil.isNullAndEmpty(object[19]) ? QwyUtil.fmyyyyMMddHHmmss.parse(object[19].toString()) : null);
